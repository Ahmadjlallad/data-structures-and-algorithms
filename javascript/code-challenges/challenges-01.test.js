...
const addOne = (arr) => {
  // Solution code here...
  const localArray = [];
  arr.forEach((el) => localArray.push(el + 1));
  return localArray;
};
...
const addExclamation = (arr) => {
  // Solution code here...
  const localArray = [];
  arr.forEach((el) => localArray.push(el + "!"));
  return localArray;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  const localArray = [];
  arr.forEach((el) => localArray.push(el.toUpperCase()));
  return localArray;
};
...
Write a function named addValues that takes in an array and a
value and pushes the value into the array. This function does
...
Then, write a function named addNumbers that takes in four arguments:
  ...
  - A callback function
  to use to add the numbers to the array
...
const addNumbers = (num, arr, times, callback) => {
  ...
  const timeToAdd = new Array(times).fill(num);
  timeToAdd.forEach((_) => callback(localArray, num));
  return localArray;
};
/* ------------------------------------------------------------------------------------------------
...
const createList = (availableItems) => {
  ...
  availableItems.forEach(
    (item) => item.available && localArray.push(item.name)
  );
  return localArray;
};
...
const fizzbuzz = (arr) => {
  ...
  const localArray = [];
  arr.forEach((num) => {
    if (num % 3 === 0 && num % 5 === 0) return localArray.push("Fizz Buzz");
    else if (num % 3 === 0) return localArray.push("Fizz");
    else if (num % 5 === 0) return localArray.push("Buzz");
    else if (!(num % 3 === 0) && !(num % 5 === 0)) return localArray.push(num);
  });
  return localArray;
};
