...
const sortStarWarsCharacters = (starWarsArr) => {
  ...
  return starWarsArr.sort(
    ({ height }, { height: height2 }) => Number(height2) - Number(height)
  );
};
...
const removeThree = (idx, arr) => {
  // Solution code here...
  return [arr.slice(0, idx), ...arr.slice(idx + 3)].flat();
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
const howMuchPencil = (str) => {
  let result = [];
  // Solution code here...
  str.split("").forEach((el, i) => result.push(str.slice(i)));
  result.push("");
  return result;
};
...
const listFoods = (recipe) => {
  ...
  recipe.ingredients.forEach((ingredient) => {
    // * at this point i don't know if I am allowed to use regular expression or not but its match faster
    // * and there is a new string method call replaceAll but
    // * https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/replaceAll
    // * but look like this method not supported by node yet
    result.push(
      ingredient.replace(
        /\d |\d|\d |medium-sized |pounds |pound |cups |cup |gallons /gm,
        ""
      )
    );
  });
...
Write a function named splitFoods that uses split to produce
the same output as Challenge 3.
...
Write a function named stepAction that takes in the
recipe and extracts the action verbs from the steps.
Fortunate for you, the action verbs are the first word of each
action.
...
const stepActions = (recipe) => {
  ...
  recipe.steps.forEach((element) => {
    result.push(element.slice(0, element.search(" ")));
  });
  return result;
};
...
Write a function named removeEvenValues that,
...
const removeEvenValues = (arr) => {
  ...
  const dumbArr = [...arr];
  arr.splice("");
  dumbArr.forEach((num) => (num % 2 === 1 ? arr.push(num) : null));
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 10 - Stretch Goal

Write a function named removeLastCharacters that takes
in a string and a number. The numberOfCharacters argument determines
...
given a string of comma-separated values (CSV)
as input. (e.g. "1,2,3"), returns the total sum of the
numeric values (e.g. 6).
------------------------------------------------------------------------------------------------ */

const totalSumCSV = (str) => {
  let total = 0;
  // Solution code here...
  const modified = str.replace(/,/gm, " ").split(" ");
  console.log(modified);
  total = modified.reduce((a, b) => +a + +b);
  return Number(total);
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 12 - Stretch Goal

Write a function named removeVowels that takes in a string
and returns a new string where all the vowels of the original
...
const removeVowels = (str) => {
  // Solution code here...
  return str.replace(/a|e|i|o|u/gm, "");
};
...
const extractVowels = (str) => {
  // Solution code here...
  const helperVar = removeVowels(str);
  const regex = new RegExp(`[${helperVar}]`, "gm");
  return [helperVar, str.replace(regex, "").split("").sort().join("")];
};
/* ------------------------------------------------------------------------------------------------
TESTS
