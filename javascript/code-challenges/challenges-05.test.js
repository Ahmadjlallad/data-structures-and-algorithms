...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((acc, { purchasePrice }) => acc + purchasePrice, 0);
};
...
Note: You must use reduce for this challenge. You may not use the built-in
...
given the array of characters, below, uses reduce to return the total number of
...
const countNumberOfChildren = (arr) => {
  ...
  return arr.reduce((acc, { children }) => {
    return children ? children.length + acc : acc;
  }, 0);
};
...
Write a function named extractStatethat,
given the snorlaxData, below,
...
given the array of characters from challenge 4, accomplishes the following:

1) Uses filter to return an array of the characters that contain the letter 'a'
in their name

2) Then, uses reduce to return an array of all
the children's names in the filtered array
------------------------------------------------------------------------------------------------ */
