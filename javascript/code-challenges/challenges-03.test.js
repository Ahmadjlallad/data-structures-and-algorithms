...
two to every value using a for loop. Place the new value in a new array. Return the new array.
------------------------------------------------------------------------------------------------ */
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  return arr.filter((item) => !forbiddenValues.includes(item) && item);
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 6 - Stretch Goal

Write a function named getBaseStatGreaterThan that, given the
snorlaxData, below, and an integer as input, uses filter to return an array containing all stats with a
baseStat greater than the integer.

For example, getBaseStatGreaterThan(snorlaxData.stats, 50) will
return an array containing the 'special-defense' and 'special-attack' objects.
------------------------------------------------------------------------------------------------ */
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  return arr.filter(({ baseStat }) => baseStat > minBaseStat);
};
...
getBaseStatGreaterThan function from challenge 7. For this function, extend your solution from challenge 7 to only return the
name of the stat, rather than the entire stat object.
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  return arr
    .filter(({ baseStat }) => baseStat > minBaseStat)
    .map(({ stat: { name } }) => name);
};
...
Write a function named getCharactersWithoutChildren that,
given the array of characters,
below, uses filter to return an array of all characters
without children.
------------------------------------------------------------------------------------------------ */
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  return arr.filter(({ children }) => !children);
};
...
given an array as input, uses filter to remove any non-numeric values,
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  return typeNum(arr).map((num) => (num % 2 === 0 ? "even" : "odd"));
};
