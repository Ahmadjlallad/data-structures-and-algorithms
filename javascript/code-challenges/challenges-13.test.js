...
strings and returns the index position of the longest string.
------------------------------------------------------------------------------------------------ */

const longestString = (arr) => {
  // Solution code here...
  return arr.indexOf(
    arr.reduce((acc, pre) => (acc.length > pre.length ? acc : pre), 0)
  );
};
...
Write a function named firstLetters that takes in an
array of strings and returns an array containing only
...
an array of strings and returns an array containing only the strings
...
const findHappiness = (arr) => {
  // Solution code here..
  const helpArr = [];
  arr.filter((str, i, arr) => {
    if (str.includes(`(:`) || str.includes(`:)`)) return helpArr.push(arr[i]);
  });
  return helpArr;
};
/* ------------------------------------------------------------------------------------------------
...
Write a function named standardizePhoneNumbers that
takes in an array of phone number strings in (XXX) XXX-XXXX
format and returns an array with the phone number strings in
XXXXXXXXXX format.
...
that takes in a string and returns only the odd-index
...
const onlyOddChars = (str) => {
  // Solution code here...
  return [...str].filter((str, i) => i % 2 === 1).join("");
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 6

Write a function named allHappy that takes in an array
of strings and returns a Boolean indicating whether all those
strings contain ":)".
------------------------------------------------------------------------------------------------ */
